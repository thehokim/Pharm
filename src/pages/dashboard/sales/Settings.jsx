...
const Settings = () => {
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/login"; // или другой путь авторизации
  };
    ...
    <div className="space-y-6 bg-white rounded-xl p-4 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="flex items-center gap-2 text-red-600 border border-red-100 hover:bg-red-50 px-4 py-2 rounded-xl text-sm transition"
        >
      ...
      <div className="bg-gray-50 rounded-xl p-4 flex justify-between items-center">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="w-12 h-7 bg-gray-200 rounded-full peer peer-checked:bg-blue-500 peer-transition-all duration-300"></div>
          <div className="absolute left-1 top-1 w-5 h-5 bg-white rounded-full peer-checked:translate-x-full transition-transform duration-300" />
        </label>
      </div>
