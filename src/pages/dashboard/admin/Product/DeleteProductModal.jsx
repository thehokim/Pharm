...
import { X, AlertTriangle, Trash2, Shield, Package, Pill } from "lucide-react";
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-gray-400 text-sm">{t("deleting_product")}</p>
                <p className="text-white font-semibold">
                  {product?.name || t("no_name")}
                </p>
                {product?.category && (
                  <p className="text-red-400 text-sm">
                    {t("category")}: {product.category === 'medicine' ? t("medicine_product") : t("household_goods")}
                  </p>
                )}
                {product?.barcode && (
