...
import { X, AlertTriangle, Trash2, Shield, Truck, Building } from "lucide-react";
...
const DeleteSupplierModal = ({ isOpen, onClose, onConfirm, supplier }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      console.error(t("error_deleting_supplier"), error);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-gray-400 text-sm">{t("deleting_supplier")}</p>
                <p className="text-white font-semibold">
                  {supplier?.name || t("noName")}
                </p>
