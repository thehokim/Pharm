...
import { X, AlertTriangle, Trash2, Shield, ShoppingCart, Hash, User, DollarSign } from "lucide-react";
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-gray-400 text-sm">{t("deleting_order")}</p>
                ...
                {order.total_amount !== undefined && (
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <p className="text-amber-400 text-sm">
                      {t("sum_colon")} {order.total_amount.toLocaleString()} {t("delete_sum")}
                    </p>
                  </div>
                )}
                {order.created_at && (
                  <p className="text-gray-400 text-xs mt-1">
                    {t("date_colon")} {new Date(order.created_at).toLocaleDateString()}
                  </p>
                )}
              </div>
            </div>
