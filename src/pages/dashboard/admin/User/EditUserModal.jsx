import { X, ChevronDown, Edit3, User, Shield, Lock, CheckCircle, Users, Activity, Briefcase, Database, Camera, Save } from "lucide-react";
...
const EditUserModal = ({ isOpen, onClose, userData, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4"
      ...
      <div className="relative bg-gray-900/95 backdrop-blur-xl border-2 border-cyan-400/30 rounded-3xl w-full max-w-lg overflow-hidden"
          ...
          {userData && (
            <div className="bg-gray-800/30 border border-gray-700/50 rounded-2xl p-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-gray-400 text-sm">{t("editing_user")}</p>
                  <p className="text-white font-semibold">{userData.name || userData.full_name}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                type="password"
                placeholder={t("placeholder_repeat_new_password")}
