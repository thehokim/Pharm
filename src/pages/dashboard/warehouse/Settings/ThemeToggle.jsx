  ...
  >
    ...
    <defs>
      <clipPath id="clip0_1611_4242">
        <rect width="24" height="24" fill="#64b5f6" />
      </clipPath>
    </defs>
  </svg>
);
...
function ThemeToggle({ value, onChange }) {
  ...
  return (
    ...
    >
      {/* Акцентный бегунок */}
      <span
        className="absolute top-1/2 -translate-y-1/2 w-[40px] h-[40px] rounded-full transition-all duration-300"
        style={{
          left: value ? "48px" : "4px",
          background: value ? "#023eba" : "#FFff00",
          display: "flex",
          alignItems: "center",
